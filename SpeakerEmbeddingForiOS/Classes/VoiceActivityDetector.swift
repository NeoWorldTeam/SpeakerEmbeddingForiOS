...
public class VoiceActivityDetector {
    private var _modelHandler: VADModelHandler?
    ...
    private func loadModel() {
        ...
        _modelHandler = VADModelHandler(modelFilename: "silero_vad_cache", modelExtension: "onnx", threadCount: 4)
    }
...
//    }
    ...
    fileprivate func _detectVAD(_ buffer: AVAudioPCMBuffer, _ windowSampleNums: Int, _ modelHandler: VADModelHandler ) -> [VADResult]  {
